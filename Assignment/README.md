...
| Assignment | Topic | Key Skills Demonstrated | Status | Link |
| :--- | :--- | :--- | :--- | :--- |
| **Assignment I** | Git/GitHub & GitHub Pages | Version control, Repository management, Markdown documentation, Static site deployment (GitHub Pages). | Completed | [Assignment I](./AssignmentI/README.md) |
