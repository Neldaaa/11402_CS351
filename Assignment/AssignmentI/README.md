...
- **Course Repository URL:** [https://github.com/Neldaaa/11402_CS351]
- **Personal Website (GitHub Pages) URL:** [https://neldaaa.github.io/]

### Completion Checklist
- [x] GitHub account is set up
- [x] Repositories created and pushed successfully
- [x] README.md written with Markdown
- [x] GitHub Pages enabled and accessible
- [x] Submission form completed with correct links
